...
export type { IFinancialInfo, TDepreciationMethod };

// Enums
export enum TAssetCategory {
  FURNITURE = 'furniture',
  EQUIPMENT = 'equipment',
...
export enum TProcurementStatus {
  REQUESTED = 'requested',
  APPROVED = 'approved',
  ORDERED = 'ordered',
  RECEIVED = 'received',
...
export enum TInventoryMaintenanceType {
...
export enum TInventoryMaintenanceStatus {
  SCHEDULED = 'scheduled',
...
export type TMaintenanceType = TInventoryMaintenanceType;
export type TMaintenanceStatus = TInventoryMaintenanceStatus;
...
export interface IAssetAssignment {
  id: string;
  assignedTo: string; // user or department ID
  assignedBy: string;
  assignedDate: Date;
  returnDate?: Date;
