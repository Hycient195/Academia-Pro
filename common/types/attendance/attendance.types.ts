// Academia Pro - Attendance Management Types
// Shared type definitions for attendance management module
...
export interface IAttendanceAlertRequest {
  ...
  threshold?: number;
  message: string;
  recipients: string[]; // parent emails/phone numbers
