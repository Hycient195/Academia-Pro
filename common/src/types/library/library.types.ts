...
export enum TAcquisitionMethod {
  PURCHASE = 'purchase',
  DONATION = 'donation',
  EXCHANGE = 'exchange',
  GIFT = 'gift',
...
export enum TReservationStatus {
  ACTIVE = 'active',
  CANCELLED = 'cancelled',
  EXPIRED = 'expired',
  FULFILLED = 'fulfilled',
...
// Checkout and Reservation Interfaces
