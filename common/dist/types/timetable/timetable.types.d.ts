export declare enum TDayOfWeek {
    SUNDAY = 0,
    MONDAY = 1,
    TUESDAY = 2,
    WEDNESDAY = 3,
...
export declare enum TPeriodType {
...
export declare enum TRecurrenceType {
    NONE = "none",
    DAILY = "daily",
    WEEKLY = "weekly",
    MONTHLY = "monthly",
...
export declare enum TTimetableStatus {
    DRAFT = "draft",
    PUBLISHED = "published",
    ACTIVE = "active",
    ARCHIVED = "archived",
...
export declare enum TPriorityLevel {
    LOW = "low",
    NORMAL = "normal",
    HIGH = "high",
    URGENT = "urgent"
