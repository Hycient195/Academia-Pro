export declare enum TContentType {
    VIDEO = "video",
    DOCUMENT = "document",
...
export declare enum TContentStatus {
    DRAFT = "draft",
    REVIEW = "review",
    PUBLISHED = "published",
    ARCHIVED = "archived",
...
export declare enum TDifficultyLevel {
    BEGINNER = "beginner",
    INTERMEDIATE = "intermediate",
    ADVANCED = "advanced",
    EXPERT = "expert"
}
export declare enum TLearningPathType {
    SUBJECT = "subject",
    SKILL = "skill",
    CAREER = "career",
...
export declare enum TProgressStatus {
...
export declare enum TEnrollmentStatus {
    ACTIVE = "active",
    COMPLETED = "completed",
    DROPPED = "dropped",
    EXPIRED = "expired",
...
export declare enum TDiscussionType {
    QUESTION = "question",
    DISCUSSION = "discussion",
    ANNOUNCEMENT = "announcement",
    CLARIFICATION = "clarification"
}
export declare enum TCollaborationType {
