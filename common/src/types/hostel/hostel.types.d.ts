export declare enum THostelType {
    BOYS = "boys",
    GIRLS = "girls",
    MIXED = "mixed",
...
export declare enum THostelStatus {
    ACTIVE = "active",
    INACTIVE = "inactive",
...
export declare enum TRoomStatus {
    AVAILABLE = "available",
    OCCUPIED = "occupied",
    RESERVED = "reserved",
    UNDER_MAINTENANCE = "under_maintenance",
...
export declare enum TBedStatus {
    AVAILABLE = "available",
    OCCUPIED = "occupied",
    RESERVED = "reserved",
    OUT_OF_ORDER = "out_of_order",
...
export declare enum TFacilityType {
    WIFI = "wifi",
    LAUNDRY = "laundry",
    GYM = "gym",
...
export declare enum TAllocationStatus {
    ACTIVE = "active",
