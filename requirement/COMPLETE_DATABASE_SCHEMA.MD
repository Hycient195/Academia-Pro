...
CREATE TABLE users (
    ...
    role VARCHAR(50) NOT NULL CHECK (role IN ('super_admin', 'school_admin', 'principal', 'vice_principal', 'staff', 'student', 'parent', 'support_staff', 'librarian', 'transport_coordinator', 'hostel_warden')),
