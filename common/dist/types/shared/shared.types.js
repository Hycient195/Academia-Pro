...
exports.createUserSchema = zod_1.z.object({
    ...
    roles: zod_1.z.array(zod_1.z.enum(['super-admin', 'delegated-super-admin', 'school-admin', 'delegated-school-admin', 'staff', 'student', 'parent'])).min(1, 'At least one role is required'),
