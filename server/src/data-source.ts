...
export const AppDataSource = new DataSource({
  ...
  entities: [
    ...
    'src/staff/**/*.entity{.ts,.js}',
    'src/parent/**/*.entity{.ts,.js}',
    'src/timetable/**/*.entity{.ts,.js}',
    'src/online-learning/**/*.entity{.ts,.js}',
    'src/reports/**/*.entity{.ts,.js}',
    'src/student-portal/**/*.entity{.ts,.js}',
